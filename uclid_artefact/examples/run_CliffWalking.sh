...
echo "Running uclid on cliff walking.ucl to synthesise agent using CVC5... this takes a while"
echo "uclid -y \"cvc5 --lang=sygus2\" cliff_walking.ucl"
time uclid -y "cvc5 --lang=sygus2" cliff_walking.ucl


echo "Running uclid on cliff walking.ucl to synthesise agent using delphi"
